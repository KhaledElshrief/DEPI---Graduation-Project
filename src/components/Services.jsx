  ...
  const services = [
    {
      ...
      icon: '/images/sheet2.webp', // Replace this with an image/icon path
    },
    {
      id: 2,
      title: 'مدرسين خصوصي',
      ...
      buttonText: 'مدرسين',
      icon: '/images/sheet.png', // Replace this with an image/icon path
    },
    {
      id: 3,
      title: 'دورات مسجلة',
      ...
      icon: '/images/headphone.webp', // Replace this with an image/icon path
    },
    {
      id: 4,
      ...
      icon: '/images/zoom.webp', // Path to the uploaded Zoom icon
    }
  ];
          ...
          {services.map((service) => (
            <div key={service.id} className="bg-yellow-400 text-right rounded-lg p-6 shadow-md flex flex-col justify-between">
              ...
              <div className="mt-auto">
                <button className="bg-black text-white py-2 px-4 rounded-full hover:bg-gray-800 w-full">
                  {service.buttonText}
                </button>
              </div>
            </div>
