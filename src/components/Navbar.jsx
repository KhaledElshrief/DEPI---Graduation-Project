                        ...
                        <li className="relative group hover:text-black cursor-pointer mb-2 lg:mb-0">
                            ...
                            <ul
                                className={`lg:absolute ${
                                    isStudentDropdownOpen ? "block" : "hidden"
                                } lg:hidden lg:group-hover:block left-0 mt-0 w-48 bg-white shadow-lg border border-gray-200 z-10 rounded-lg`}
                            >
                                <NavLink to="/courses">
                                    ...
                                    <ul
                                        className={`absolute ${
                                            isProfileDropdownOpen
                                                ? "block"
                                                : "hidden"
                                        } right-0 mt-2 w-48 bg-white shadow-lg border border-gray-200 z-10 rounded-lg`}
                                    >
                                        <NavLink to="/profile">
                                            <li className="px-4 py-2 hover:bg-gray-100">
                                                الملف الشخصي
